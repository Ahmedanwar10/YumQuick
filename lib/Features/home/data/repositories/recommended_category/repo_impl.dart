...
Future<Either<Failure, RecommendedCategory>> getRecommendedCategory() async {
  try {
    final response = await recommendedCategoryService.getRecommendedCategories();
    if (response != null && response.data != null) {
      return Right(RecommendedCategory.fromJson(response.data)); // ✅ إرجاع RecommendedCategory بالكامل
    } else {
